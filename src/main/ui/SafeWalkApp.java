...
public class SafeWalkApp {

    private static final String JSON_STORE = "./data/temp.json";
    ...
    public SafeWalkApp() throws FileNotFoundException {
    ...
    private void runScheduler() {
        ...
        while (keepGoing) {
            ...
            System.out.println("1. Are you volunteer");
            System.out.println("2. Are you Client");
            System.out.println("3. Load application");
            System.out.println("4. Save application");
    ...
    private void goVolunteer(Scanner scanner, Volunteer volunteer, Scheduler scheduler, User user) {
    ...
    private void saveApp() {
        try {
            ...
            jsonWriter.close();
            System.out.println("Saved " + user.temp() + " to " + JSON_STORE);
        } catch (Exception e) {
    ...
    private void loadApp() {
        try {
            ...
            System.out.println("Loaded " + user.temp() + " from " + JSON_STORE);
        } catch (Exception e) {
